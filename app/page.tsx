...
export default function Home() {
  return (
    <div className="flex flex-col gap-10">
      <div className="flex flex-1 w-full  flex-col items-center justify-between py-16 px-16 bg-black/10 dark:bg-black sm:items-start gap-4">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <Link passHref href={'zapisz-sie'}>
            <Button className="w-full">Wybierz kurs</Button>
          </Link>
          <Button variant="outline">Zobacz jak wygląda nauka</Button>
        </div>
      </div>
      <div className="flex flex-1 w-full  flex-col items-center justify-between py-16 px-16 bg-black/10 dark:bg-black sm:items-start gap-4">
